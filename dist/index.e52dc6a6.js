const t=document.querySelector(".cartQty"),e=document.getElementById("catalogoSection");function o(){let e=JSON.parse(localStorage.getItem("cart"));e?t.innerText=e.reduce((t,e)=>t+e.qty,0):t.innerText=0}o();class n{constructor(t,e,o,n){this.id=t,this.nombre=e,this.imagen=o,this.precio=n}}console.log("show products Function"),[{id:"cb1",nombre:"Claus Bag 1",imagen:"public/products/HK-06_xs.webp",precio:"55000"},{id:"cb2",nombre:"Claus Bag 2",imagen:"public/products/HK-08_xs.webp",precio:"55000"},{id:"cb3",nombre:"Claus Bag 3",imagen:"public/products/cb_3_xs.webp",precio:"55000"},{id:"cb4",nombre:"Claus Bag 4",imagen:"public/products/HK-X8_xs.webp",precio:"55000"},{id:"cb5",nombre:"Claus Bag 5",imagen:"public/products/HK-32_xs.webp",precio:"55000"},{id:"cb6",nombre:"Claus Bag 6",imagen:"public/products/CB-LineaVerde_xs.webp",precio:"55000"},{id:"cb7",nombre:"Claus Bag 7",imagen:"public/products/CB-LineaRoja_xs.webp",precio:"55000"},{id:"cb8",nombre:"Claus Bag 8",imagen:"public/products/HK-19_xs.webp",precio:"55000"}].forEach(t=>{let e=document.createElement("div");e.setAttribute("class","productContainer w-full shadow-xl flex flex-row p-1 sm:p-4 dark:bg-[#1E3D32] bg-white rounded-lg border border-gray-300  md:w-[48%] lg:w-[49%]"),e.innerHTML=`
...
//# sourceMappingURL=index.e52dc6a6.js.map
