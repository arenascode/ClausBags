const t=document.querySelector(".cartQty"),e=document.getElementById("catalogoSection");function o(){let e=JSON.parse(localStorage.getItem("cart"));e?t.innerText=e.reduce((t,e)=>t+e.qty,0):t.innerText=0}o();class n{constructor(t,e,o,n){this.id=t,this.nombre=e,this.imagen=o,this.precio=n}}let r=[];fetch("products.json").then(t=>t.json()).then(t=>{t.forEach(t=>{let e=document.createElement("div");e.setAttribute("class","productContainer w-full shadow-xl flex flex-row p-1 sm:p-4 dark:bg-[#1E3D32] bg-white rounded-lg border border-gray-300  md:w-[48%] lg:w-[49%]"),e.innerHTML=`
...
//# sourceMappingURL=index.a7b5a87a.js.map
