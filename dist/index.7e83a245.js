const e=document.querySelector(".cartQty"),t=document.getElementById("catalogoSection");function o(){let t=JSON.parse(localStorage.getItem("cart"));t?e.innerText=t.reduce((e,t)=>e+t.qty,0):e.innerText=0}o();class n{constructor(e,t,o,n){this.id=e,this.nombre=t,this.imagen=o,this.precio=n}}console.log("show products Function"),[{id:"cb1",nombre:"Claus Bag 1",imagen:"/products/HK-06_xs.webp",precio:"55000"},{id:"cb2",nombre:"Claus Bag 2",imagen:"/products/HK-08_xs.webp",precio:"55000"},{id:"cb3",nombre:"Claus Bag 3",imagen:"/products/cb_3_xs.webp",precio:"55000"},{id:"cb4",nombre:"Claus Bag 4",imagen:"/products/HK-X8_xs.webp",precio:"55000"},{id:"cb5",nombre:"Claus Bag 5",imagen:"/products/HK-32_xs.webp",precio:"55000"},{id:"cb6",nombre:"Claus Bag 6",imagen:"/products/CB-LineaVerde_xs.webp",precio:"55000"},{id:"cb7",nombre:"Claus Bag 7",imagen:"/products/CB-LineaRoja_xs.webp",precio:"55000"},{id:"cb8",nombre:"Claus Bag 8",imagen:"/products/HK-19_xs.webp",precio:"55000"}].forEach(e=>{let t=document.createElement("div");t.setAttribute("class","productContainer w-full shadow-xl flex flex-row p-1 sm:p-4 dark:bg-[#1E3D32] bg-white rounded-lg border border-gray-300  md:w-[48%] lg:w-[49%]"),t.innerHTML=`
...
//# sourceMappingURL=index.7e83a245.js.map
